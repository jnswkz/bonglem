...
export default function ProductsPage({ onNavigate }: ProductsPageProps) {
  ...
  // ⚡ Bolt: Memoize filtered products to prevent re-calculating on every render
  // and process the search query to lower case once before the loop to prevent redundant string operations per product
